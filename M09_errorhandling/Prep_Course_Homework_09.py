...
sys.path.append('/Users/caica/Python-Prep/M08_clasesyOOP/Prep_Course - Error Handling/herramientas.py')
...
importlib.reload(h)
h.Herramientas([2, 3, 5, 6, 2])

h1.conversion_grados(1, 2)

h1.conversion_grados('celsius', 'farenheit')

# Importar el modulo "unittest" y crear los siguientes casos de pruebas sobre la clase utilizada en el punto 2<br>
